window.themingStore.views.AbstractView = Backbone.View.extend({
   ...
   */
  loadTemplate: function (url, name, callback, syncp)
  {
   ...
   * @param {object}   options     an object containing the values to fetch or load
   * @param {string[]} [options.templates]      the templates as array or object
   * @param {object[]} [options.models]         an array or object containing models or collections to fetch
   * @param {function} [options.templatesReady] a function to be called when the templates arrive
   * @param {function} [options.modelsReady]    a function to be called when the models or collections are fetched
   * @param {function} [options.ready]          a function to be called when everything is ready
   * <code>
   * this.loadTemplates({ templates: ['login'] });
   * this.loadTemplates({ templates: {login : 'login'}, ready: function () {} });
   * </code>
